...
through all 12 blocks and samples the next token to continue.

There is no training that happens here becasue the weights have been already been learned based on 40gb of text from the internet
we are just using it here to predict text
